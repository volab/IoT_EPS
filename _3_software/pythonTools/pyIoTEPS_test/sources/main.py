...
====================
    ...
    :Autheur: J.Soranzo
    :version: 20220627
    :Dépendences: tkinter et pySerial (au niveau de la classe mainUi_C)
    :Licence: (c) 2022 VoRoBoTics
    :Projet: IoT Eps
    :Société: VoRoBoTics
    :Entité: VoLAB
...
from CGui import mainUi
from constantes import FEN_HAUTEUR

def main():
    """Programme principal de l'IHM de test du projet RDC Capteurs.

    Ce script Python lance l'interface graphique basée sur tkinter via la classe mainUi_C.mainUi
    mainUi_C.
    ...
    root.after(gui.RS_HANDLER_PERIOD, gui.rsHandler)
    root.mainloop()
